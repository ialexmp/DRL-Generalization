...
from Custom_Env.custom_envs import (
    CustomMountainCarGoalPositionEnv,
    CustomMountainCarInverseGoalPositionEnv,
...
from Algorithms.PPO_MountainCar.Network_MC import ActorNetwork, CriticNetwork
...
def main(experiment_name):
    ...
    custom_envs = [
        ...
        'CustomMountainCarInverseGoalPosition',
    ...
    for env_name in custom_envs:
        ...
        print(f"Average reward over {num_episodes} episodes in {env_name}: {avg_reward}")
